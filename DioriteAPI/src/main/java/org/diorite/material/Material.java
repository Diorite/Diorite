...
//    public static final  Material                FLINT_AND_STEEL      = new Material("FLINT_AND_STEEL", 259, 1, 64);
    public static final  Material                    APPLE                      = AppleMat.APPLE;
...
//    public static final  Material                BOWL                 = new Material("BOWL", 281);
    public static final  Material                    MUSHROOM_STEW              = MushroomStewMat.MUSHROOM_STEW;
...
//    public static final  Material                WHEAT                = new Material("WHEAT", 296);
    public static final  Material                    BREAD                      = BreadMat.BREAD;
...
//    public static final  Material                FLINT                = new Material("FLINT", 318);
    public static final  Material                    PORKCHOP                   = PorkchopMat.PORKCHOP;
    public static final  Material                    COOKED_PORKCHOP            = CookedPorkchopMat.COOKED_PORKCHOP;
    //    public static final  Material                PAINTING             = new Material("PAINTING", 321);
    public static final  Material                    GOLDEN_APPLE               = GoldenAppleMat.GOLDED_APPLE;
...
//    public static final  Material                LEATHER              = new Material("LEATHER", 334);
    public static final  Material                    MILK_BUCKET                = MilkBucketMat.MILK_BUCKET;
...
//    public static final  Material                GLOWSTONE_DUST       = new Material("GLOWSTONE_DUST", 348);
    public static final  Material                    FISH                       = FishMat.FISH;
    public static final  Material                    COOKED_FISH                = CookedFishMat.COOKED_FISH;
...
//    public static final  Material                MELON_SEEDS          = new Material("MELON_SEEDS", 362);
    public static final  Material                    BEEF                       = BeefMat.BEEF;
    public static final  Material                    COOKED_BEEF                = CookedBeefMat.COOKED_BEEF;
    public static final  Material                    CHICKEN                    = ChickenMat.CHICKEN;
    public static final  Material                    COOKED_CHICKEN             = CookedChickenMat.COOKED_CHICKEN;
    public static final  Material                    ROTTEN_FLESH               = RottenFleshMat.ROTTEN_FLESH;
...
//    public static final  Material                GLASS_BOTTLE         = new Material("GLASS_BOTTLE", 374);
    public static final  Material                    SPIDER_EYE                 = SpiderEyeMat.SPIDER_EYE;
...
//    public static final  Material                FLOWER_POT_ITEM      = new Material("FLOWER_POT_ITEM", 390);
    public static final  Material                    CARROT                     = CarrotMat.CARROT;
    public static final  Material                    POTATO                     = PotatoMat.POTATO;
    public static final  Material                    BAKED_POTATO               = BakedPotatoMat.BAKED_POTATO;
    public static final  Material                    POISONOUS_POTATO           = PoisonousPotatoMat.POISONOUS_POTATO;
    //    public static final  Material                EMPTY_MAP            = new Material("EMPTY_MAP", 395);
    public static final  Material                    GOLDEN_CARROT              = GoldenCarrotMat.GOLDEN_CARROT;
...
//    public static final  Material                NETHER_STAR          = new Material("NETHER_STAR", 399);
    public static final  Material                    PUMPKIN_PIE                = PumpkinPieMat.PUMPKIN_PIE;
...
//    public static final  Material                PRISMARINE_CRYSTALS  = new Material("PRISMARINE_CRYSTALS", 410);
    public static final  Material                    RABBIT                     = RabbitMat.RABBIT;
    public static final  Material                    COOKED_RABBIT              = CookedRabbitMat.COOKED_RABBIT;
    public static final  Material                    RABBIT_STEW                = RabbitStewMat.RABBIT_STEW;
...
//    public static final  Material                COMMAND_MINECART     = new Material("COMMAND_MINECART", 422, 1);
    public static final  Material                    MUTTON                     = MuttonMat.MUTTON;
    public static final  Material                    COOKED_MUTTON              = CookedMuttonMat.COOKED_MUTTON;
