...
public class IronBlockMat extends OreBlockMat
{
    ...
    {
        super("IRON_BLOCK", 42, "minecraft:iron_block", "IRON_BLOCK", (byte) 0x00, Material.IRON_ORE, 5, 30);
    }

    protected IronBlockMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final OreMat ore, final float hardness, final float blastResistance)
    {
