...
public class SpruceDoor extends WoodenDoor
{
    ...
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_EAST       = new SpruceDoor();
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_SOUTH      = new SpruceDoor("BOTTOM_SOUTH", BlockFace.SOUTH, false);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_WEST       = new SpruceDoor("BOTTOM_WEST", BlockFace.WEST, false);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_NORTH      = new SpruceDoor("BOTTOM_NORTH", BlockFace.NORTH, false);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_OPEN_EAST  = new SpruceDoor("BOTTOM_OPEN_EAST", BlockFace.EAST, true);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_OPEN_SOUTH = new SpruceDoor("BOTTOM_OPEN_SOUTH", BlockFace.SOUTH, true);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_OPEN_WEST  = new SpruceDoor("BOTTOM_OPEN_WEST", BlockFace.WEST, true);
    public static final SpruceDoor SPRUCE_DOOR_BOTTOM_OPEN_NORTH = new SpruceDoor("BOTTOM_OPEN_NORTH", BlockFace.NORTH, true);
    public static final SpruceDoor SPRUCE_DOOR_TOP_LEFT          = new SpruceDoor("TOP_LEFT", false, false);
    public static final SpruceDoor SPRUCE_DOOR_TOP_RIGHT         = new SpruceDoor("TOP_RIGHT", false, true);
    public static final SpruceDoor SPRUCE_DOOR_TOP_LEFT_POWERED  = new SpruceDoor("TOP_LEFT_POWERED", true, false);
    public static final SpruceDoor SPRUCE_DOOR_TOP_RIGHT_POWERED = new SpruceDoor("TOP_RIGHT_POWERED", true, true);
    ...
    {
        super("SPRUCE_DOOR", 195, "minecraft:jungle_door", "BOTTOM_EAST", WoodType.SPRUCE);
        this.powered = false;
    ...
    public SpruceDoor(final String enumName, final boolean powered, final boolean hingeOnRightSide)
    {
        super(SPRUCE_DOOR_BOTTOM_EAST.name(), SPRUCE_DOOR_BOTTOM_EAST.getId(), SPRUCE_DOOR_BOTTOM_EAST.getMinecraftId(), enumName, Door.combine(powered, hingeOnRightSide), WoodType.SPRUCE);
    ...
    public SpruceDoor(final String enumName, final BlockFace blockFace, final boolean open)
    {
        super(SPRUCE_DOOR_BOTTOM_EAST.name(), SPRUCE_DOOR_BOTTOM_EAST.getId(), SPRUCE_DOOR_BOTTOM_EAST.getMinecraftId(), enumName, Door.combine(blockFace, open), WoodType.SPRUCE);
        this.powered = false;
        this.hingeOnRightSide = false;
        this.open = open;
        this.topPart = false;
    ...
    @Override
    public SpruceDoor getType(final boolean isPowered, final boolean hingeOnRightSide)
    {
        return getByID(Door.combine(isPowered, hingeOnRightSide));
    }

    @Override
    public SpruceDoor getType(final BlockFace face, final boolean isOpen)
    {
    ...
    @Override
    public SpruceDoor getTopPart(final boolean top)
    {
        if (top)
        {
    ...
    @Override
    public SpruceDoor getBlockFacing(final BlockFace face) throws RuntimeException
    {
        if (this.topPart)
        {
            throw new RuntimeException("Top part don't define facing direction of door.");
    ...
    @Override
    public SpruceDoor getOpen(final boolean open) throws RuntimeException
    {
        if (this.topPart)
        {
            throw new RuntimeException("Top part don't define if door is open!");
    ...
    @Override
    public SpruceDoor getPowered(final boolean powered) throws RuntimeException
    {
        if (! this.topPart)
        {
            throw new RuntimeException("Bottom part don't define if door is powered!");
    ...
    @Override
    public SpruceDoor getHingeOnRightSide(final boolean onRightSide) throws RuntimeException
    {
        if (! this.topPart)
        {
            throw new RuntimeException("Bottom part don't define side of hinge!");
     ...
     */
    public static SpruceDoor getSpruceDoor(final boolean powered, final boolean hingeOnRightSide)
    {
     ...
     * @return sub-type of SpruceDoor
     */
    public static SpruceDoor getSpruceDoor(final BlockFace blockFace, final boolean open)
    {
    ...
    static
    {
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_EAST);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_SOUTH);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_WEST);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_NORTH);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_OPEN_EAST);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_OPEN_SOUTH);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_OPEN_WEST);
        SpruceDoor.register(SPRUCE_DOOR_BOTTOM_OPEN_NORTH);
        SpruceDoor.register(SPRUCE_DOOR_TOP_LEFT);
        SpruceDoor.register(SPRUCE_DOOR_TOP_RIGHT);
        SpruceDoor.register(SPRUCE_DOOR_TOP_LEFT_POWERED);
        SpruceDoor.register(SPRUCE_DOOR_TOP_RIGHT_POWERED);
    }
}
