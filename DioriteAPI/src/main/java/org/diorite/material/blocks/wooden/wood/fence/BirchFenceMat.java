...
public class BirchFenceMat extends WoodenFenceMat
{
    ...
    private static final Map<String, BirchFenceMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    {
        super("BIRCH_FENCE", 189, "minecraft:birch_fence", "BIRCH_FENCE", WoodTypeMat.BIRCH);
    }

    protected BirchFenceMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final WoodTypeMat woodType)
    {
