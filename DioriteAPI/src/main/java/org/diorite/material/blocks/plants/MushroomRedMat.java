...
public class MushroomRedMat extends MushroomMat
{
    ...
    private static final Map<String, MushroomRedMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected MushroomRedMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
