...
public class OakStairsMat extends WoodenStairsMat
{
    ...
    {
        super("OAK_STAIRS", 53, "minecraft:oak_stairs", WoodTypeMat.OAK, BlockFace.EAST, false, 2, 15);
    }

    protected OakStairsMat(final BlockFace face, final boolean upsideDown)
    {
        super(OAK_STAIRS_EAST.name(), OAK_STAIRS_EAST.ordinal(), OAK_STAIRS_EAST.getMinecraftId(), WoodTypeMat.OAK, face, upsideDown, OAK_STAIRS_EAST.getHardness(), OAK_STAIRS_EAST.getBlastResistance());
    }

    protected OakStairsMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final WoodTypeMat woodType, final BlockFace face, final boolean upsideDown, final float hardness, final float blastResistance)
    {
