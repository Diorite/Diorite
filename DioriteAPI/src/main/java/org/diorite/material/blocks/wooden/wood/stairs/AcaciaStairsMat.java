...
public class AcaciaStairsMat extends WoodenStairsMat
{
    ...
    private static final Map<String, AcaciaStairsMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    private static final TByteObjectMap<AcaciaStairsMat> byID   = new TByteObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);

    @SuppressWarnings("MagicNumber")
    protected AcaciaStairsMat()
    {
        super("ACACIA_STAIRS", 163, "minecraft:acacia_stairs", WoodTypeMat.ACACIA, BlockFace.EAST, false);
    }
