...
public class MushroomRed extends Mushroom
{
    ...
    private static final Map<String, MushroomRed>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SLOW_GROW);
    private static final TByteObjectMap<MushroomRed> byID   = new TByteObjectHashMap<>(USED_DATA_VALUES, SLOW_GROW);
