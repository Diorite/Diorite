...
public class BeaconMat extends BlockMaterialData
{
    ...
    private static final Map<String, BeaconMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected BeaconMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
