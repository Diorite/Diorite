...
public class EmeraldOreMat extends OreMat
{
    ...
    {
        super("EMERALD_ORE", 129, "minecraft:emerald_ore", "EMERALD_ORE", (byte) 0x00, 3, 15);
    }

    protected EmeraldOreMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final float hardness, final float blastResistance)
    {
