...
public class HardenedClayMat extends StonyMat
{
    ...
    private static final Map<String, HardenedClayMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected HardenedClayMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
