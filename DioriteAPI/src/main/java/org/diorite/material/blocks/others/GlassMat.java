...
public class GlassMat extends BlockMaterialData
{
    ...
    private static final Map<String, GlassMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    private static final TByteObjectMap<GlassMat> byID   = new TByteObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected GlassMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
