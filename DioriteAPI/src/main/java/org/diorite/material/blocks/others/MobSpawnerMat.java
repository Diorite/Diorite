...
public class MobSpawnerMat extends BlockMaterialData
{
    ...
    private static final Map<String, MobSpawnerMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected MobSpawnerMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
