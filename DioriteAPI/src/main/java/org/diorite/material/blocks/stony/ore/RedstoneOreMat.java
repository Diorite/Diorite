...
public class RedstoneOreMat extends OreMat
{
    ...
    private static final Map<String, RedstoneOreMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected RedstoneOreMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
