...
public class CoalOreMat extends OreMat
{
    ...
    {
        super("COAL_ORE", 16, "minecraft:coal_ore", "COAL_ORE", (byte) 0x00, 3, 15);
    }

    protected CoalOreMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final float hardness, final float blastResistance)
    {
