...
public class PackedIceMat extends BlockMaterialData
{
    ...
    private static final Map<String, PackedIceMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    private static final TByteObjectMap<PackedIceMat> byID   = new TByteObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected PackedIceMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
