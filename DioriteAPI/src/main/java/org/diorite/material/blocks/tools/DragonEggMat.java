...
public class DragonEggMat extends BlockMaterialData
{
    ...
    private static final Map<String, DragonEggMat>    byName = new SimpleStringHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
    ...
    protected DragonEggMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type)
    {
