...
public class BurningFurnaceMat extends BlockMaterialData implements DirectionalMat
{
    ...
    protected BurningFurnaceMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final BlockFace face)
    {
