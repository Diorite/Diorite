...
public abstract class PistonBaseMat extends BlockMaterialData implements DirectionalMat, PowerableMat
{
    ...
    protected PistonBaseMat(final String enumName, final int id, final String minecraftId, final BlockFace facing, final boolean extended)
    {
        super(enumName, id, minecraftId, facing.name() + (extended ? "_EXTENDED" : ""), combine(facing, extended));
        this.facing = facing;
        this.extended = extended;
    }

    protected PistonBaseMat(final String enumName, final int id, final String minecraftId, final int maxStack, final String typeName, final byte type, final BlockFace facing, final boolean extended)
    {
