...
public class LeatherHelmetMat extends ArmorMat
{
    /**
    ...
    {
        super("LEATHER_HELMET", 298, "minecraft:leather_helmet", "NEW", (short) 0, ArmorMaterial.LEATHER, ArmorType.HELMET);
    }

    protected LeatherHelmetMat(final int durability)
    {
        super(LEATHER_HELMET.name(), LEATHER_HELMET.getId(), LEATHER_HELMET.getMinecraftId(), Integer.toString(durability), (short) durability, ArmorMaterial.LEATHER, ArmorType.HELMET);
    }
