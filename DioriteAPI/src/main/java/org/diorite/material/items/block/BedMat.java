...
public class BedMat extends ItemMaterialData implements PlaceableItemMat
{
    /**
    ...
    private static final TShortObjectMap<BedMat> byID   = new TShortObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
