...
public class WrittenBookMat extends ItemMaterialData
{
    ...
    private static final TShortObjectMap<WrittenBookMat> byID   = new TShortObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);

    protected WrittenBookMat()
    {
        super("WRITTEN_BOOK", 387, "minecraft:written_book", "WRITTEN_BOOK", (short) 0x00);
    }
