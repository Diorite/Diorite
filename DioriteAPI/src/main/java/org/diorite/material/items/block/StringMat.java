...
public class StringMat extends ItemMaterialData implements PlaceableItemMat
{
    /**
    ...
    private static final TShortObjectMap<StringMat> byID   = new TShortObjectHashMap<>(USED_DATA_VALUES, SMALL_LOAD_FACTOR);
