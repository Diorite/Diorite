...
public abstract class EventPipelineImpl<T extends Event> extends BasePipeline<EventPipelineHandler<T>> implements EventPipeline<T>
{
    protected final ExceptionPipeline exceptionPipeline = new ExceptionPipelineImpl();
