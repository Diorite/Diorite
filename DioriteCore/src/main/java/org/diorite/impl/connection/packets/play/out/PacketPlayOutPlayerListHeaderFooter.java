...
public class PacketPlayOutPlayerListHeaderFooter implements PacketPlayOut
{
    ...
    public PacketPlayOutPlayerListHeaderFooter(final BaseComponent header, final BaseComponent footer)
    {
        this.header = header;
        this.footer = footer;
    }
