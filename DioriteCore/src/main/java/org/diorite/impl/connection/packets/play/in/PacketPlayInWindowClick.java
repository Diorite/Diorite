...
public class PacketPlayInWindowClick implements PacketPlayIn
{
    ...
    public PacketPlayInWindowClick(final int id, final short clickedSlot, final short actionNumber, final ClickType clickType, final ItemStackImpl clicked)
    {
        this.id = id;
        this.clickedSlot = clickedSlot;
        this.actionNumber = actionNumber;
    ...
    public ItemStackImpl getClicked()
    {
        return this.clicked;
    }

    public void setClicked(final ItemStackImpl clicked)
    {
        this.clicked = clicked;
    }
