...
public class PacketPlayOutRelEntityMove extends PacketPlayOut
{
    ...
    public PacketPlayOutRelEntityMove(final int entityId, final byte deltaX, final byte deltaY, final byte deltaZ, final boolean onGround)
    {
    ...
    public PacketPlayOutRelEntityMove(final int entityId, final double deltaX, final double deltaY, final double deltaZ, final boolean onGround)
    {
        this.entityId = entityId;
