...
public class PacketPlayOutWorldParticles implements PacketPlayOut
{
    ...
    public PacketPlayOutWorldParticles(final Particle particle, final boolean longDistance, final float x, final float y, final float z, final float offsetX, final float offsetY, final float offsetZ, final float particleData, final int particleCount, final int... data)
    {
    ...
    public void readPacket(final PacketDataSerializer data) throws IOException
    {
        ...
        int dataCount = this.particle.getDataSize();
