...
public abstract class PacketStatusOut extends Packet<PacketStatusOutListener>
{
    public PacketStatusOut()
    {
    }

    public PacketStatusOut(final PacketDataSerializer data)
    {
        super(data);
    }
