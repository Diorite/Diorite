...
//        this.builder().priority(getPriority()).shapeless().addIngredient().item(DyeMat.DYE_LAPIS_LAZULI).addIngredient().item(WoolMat.WOOL_WHITE, false).build().result(WoolMat.WOOL_BLUE).buildAndAdd();
        ...
        this.grouped(this.craftingBuilder().shapeless().addIngredient().any().addClone())
            ...
            .addGroupedRecipe(g -> g.validator(this.craftingBuilder().shaped().pattern("x", "x").addIngredient('x').any())
            ...
            .addGroupedRecipe(mg -> mg.validator(this.craftingBuilder().shaped().pattern("xx").addIngredient('x').any())
        ...
        this.grouped(this.craftingBuilder().shapeless().addIngredient().any().addClone().addClone())
            ...
            .addGroupedRecipe(g -> g.validator(this.craftingBuilder().shaped().pattern("xxx").addIngredient('x').any())
                .addGroupedRecipe(g1 -> g1.validator(this.shaped_(Material.STONE_SLAB, 6, "xxx").addIngredient('x').any())
                    ...
                    .addGroupedRecipe(g2 -> g2.validator(this.shaped_(Material.WOODEN_SLAB, 6, "ppp").addIngredient('p').item(Material.PLANKS, true))
            ...
            .addGroupedRecipe(g -> g.validator(this.craftingBuilder().shaped().pattern("x", "x", "x").addIngredient('x').any())
            ...
            .addGroupedRecipe(g -> g.validator(this.craftingBuilder().shaped().pattern("x_x", "_x_").addIngredient('x').any())
        ...
        // axe
        this.grouped(this.craftingBuilder().shaped().pattern("xx", "xs", "_s").addIngredient('x').any().addIngredient('s').item(Material.STICK, false))
            ...
            .buildAndAdd();
        this.grouped(this.craftingBuilder().shaped().pattern("xx", "sx", "s_").addIngredient('x').any().addIngredient('s').item(Material.STICK, false))
        ...
        // hoe
        this.grouped(this.craftingBuilder().shaped().pattern("xx", "_s", "_s").addIngredient('x').any().addIngredient('s').item(Material.STICK, false))
            ...
            .buildAndAdd();
        this.grouped(this.craftingBuilder().shaped().pattern("xx", "s_", "s_").addIngredient('x').any().addIngredient('s').item(Material.STICK, false))
        ...
        // pickaxe
        this.grouped(this.craftingBuilder().shaped().pattern("xxx", "_s_", "_s_").addIngredient('x').any().addIngredient('s').item(Material.STICK, false))
